    ...
    <div className="flex justify-between">
      <div className="flex">
        ...
        <div className="flex flex-col p-3 m-5 my-auto space-x-4">
          <NavLink to="/" className="hover:text-slate-400 font-semibold">
            Gürkan Özkırım
          </NavLink>
          {/* Icons */}
          <div className="flex">
      ...
      <nav className="my-auto">
        <NavLink to="/" className="hover:text-slate-400 rounded-lg p-2 ">
          🏠 Anasayfa
        </NavLink>
        <NavLink to="/posts" className="hover:bg-slate-400 rounded-lg p-2">
          📝 Yazılarım
        </NavLink>
        <NavLink to="/bookmarks" className="hover:bg-slate-400 rounded-lg p-2">
          Yer İmleri
        </NavLink>
      </nav>
    </div>
